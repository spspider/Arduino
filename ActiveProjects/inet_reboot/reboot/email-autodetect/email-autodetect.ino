...
String smtp_port_str = "2525"; //smtp server port
int smtp_port = 2525;

String to_email_addr = "spspider95@gmail.com"; // destination email address
...
String emaillogin = "c3BzcGlkZXI5NQ=="; //username
