...
echo  "<br>".$total_rows;
if ($total_rows==0){$query_insert_new ="INSERT INTO settings VALUES (0,'$field','$field_data')";
...
$query_insert_new_fielddata ="UPDATE  settings SET field_data = '$field_data' WHERE id = '$change_id'";
