...
//echo "<!--";
    while ($row1 = mysql_fetch_assoc($result1)) {
     ...
     echo "_____________________I".$row1['name_pin'].":".$row1[$col_name].";";
     $col_name = mysql_field_name($fields, 3);
     echo "_____________________S".$row1['name_pin'].":".$row1[$col_name].";";
     $col_name = mysql_field_name($fields, 5);
     echo "_____________________P".$row1['name_pin'].":".$row1[$col_name].";";
     $col_name = mysql_field_name($fields, 6);
     echo "_____________________L".$row1['name_pin'].":".$row1[$col_name]."";
