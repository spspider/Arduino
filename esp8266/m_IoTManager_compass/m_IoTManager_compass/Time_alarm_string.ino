...
void loop_alarm() {
  ...
  //}
  if (millis() > check_bySignal_variable + 1000 ) {
    check_for_changes();
  ...
  if (check_internet) {
    if (millis() > update_alarm_active + 10L * 60000L ) { //каждые 10 мин
...
void make_action(char that_condtion_widget, char that_number_cond, bool opposite) {
  ...
  if (En_a[that_condtion_widget][that_number_cond] == true) {//если он включен
    ...
    if (act_a[that_condtion_widget][that_number_cond] == 2) { ////////////////////////////"нажать кнопку"////////////////////////////////////////////
      char i = that_condtion_widget;
      char payload_is = actOn_a[that_condtion_widget][that_number_cond];
      char id_button = 255;
    ...
    */
      ...
      String DataLoad_8211 = readCommonFiletoJson("ws8211/" + actBtn_a[that_condtion_widget][that_number_cond]);
      LoadData(DataLoad_8211.c_str());
    }
    else if (act_a[that_condtion_widget][that_number_cond] == 8) { /////////////////////////WakeOnLan///////////////////////////
      wakeMyPC(actBtn_a[that_condtion_widget][that_number_cond].c_str());
