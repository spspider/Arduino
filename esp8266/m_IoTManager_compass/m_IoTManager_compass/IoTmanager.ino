  ...
  switch (pinmode[i]) {
    ...
    case 11:
      ...
      if (that_stat == 0) {
        ...
        that_stat = ((that_stat  - analogSubtracter) / analogDivider); //adc pin:A0;(analogRead(17) * 1.0F - analogSubtracter) / analogDivider;
    ...
    case 10://PowerMeter должен быть последним, иначе ошибка jump to case label
      ...
      that_stat =  (that_stat  - analogSubtracter) / analogDivider;
      break;
