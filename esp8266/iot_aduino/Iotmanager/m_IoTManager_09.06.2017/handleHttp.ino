...
void handleRoot() {
  ...
  server.sendContent(
"<a class='btn btn-block btn-default' href='/wifi'>подключение к Wifi</a>"
    ""
  );
    server.sendContent("<a class='btn btn-block btn-default' href='/home'>управление</a></div></div></div></body></html>");
