...
server.on("/home", HTTP_GET, [](){handleFileRead("/home.htm");});
...
server.on("/other_setup",[](){
    ...
    IOTserver = server.arg("IOTserver"); 
    IOTport=server.arg("IOTport").toInt(); 
    IOTclient=server.arg("IOTclient"); 
    IOTpassword=server.arg("IOTpassword"); 
  //server.arg("setup1").toCharArray(setup1, sizeof(setup1) - 1);
  //server.arg("setup2").toCharArray(setup2, sizeof(setup2) - 1);
