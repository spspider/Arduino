 ...
 */
  ...
  /*
    ...
    outbound.addFloat( accXangle); // Add a reading of analog 0.
  ...
  */
  ...
  Udp.print("}");
  Udp.endPacket();
  //if (!sendPacket(Udp.remoteIP(), (uint8_t*)&accXangle, sizeof(accXangle)))
  //Serial.println(F("Error sending answering UDP packet!"));
  delay(500); // The accelerometer's maximum samples rate is 1kHz
}
